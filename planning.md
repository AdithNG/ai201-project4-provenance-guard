...
> **🤖 Likely AI-generated.** Our analysis found strong signs that this text was
> produced by an AI system rather than written by a person. This is an automated
> estimate, not a certainty — detection can be wrong. If you wrote this yourself,
> you can appeal this label.

**Uncertain** (`0.35 ≤ confidence ≤ 0.65`):
> **❓ Uncertain origin.** Our analysis couldn't confidently tell whether this text
> was written by a person or generated by AI. We're showing this honestly rather
> than guessing. The creator is welcome to add context or appeal.

**High-confidence human** (`confidence < 0.35`):
> **✍️ Likely human-written.** Our analysis found this reads as human-written, with
> the natural variation typical of a person's writing. This is an automated estimate
